...
from lara.core.io import write_text
...
class DiffTool:
    ...
    @tool(
        ...
        name="diff",
        description="Show persisted file diffs for the current Lara session or run.",
        timeout=30,
        resource_key="lara-diffs",
...
async def _diff_contract(
    ...
    raise RuntimeError("diff is resolved by the Lara runtime executor")
