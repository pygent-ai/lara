...
from lara.tracing import DiffRecorder, EventStore, read_snapshot_content
...
class FileEffectTracker:
    IGNORED_DIRS = frozenset(
        {".git", ".lara", ".venv", "__pycache__", ".pytest_cache", "sessions",
...
class ToolObserver:
    ...
    def record_framework_result(
        ...
        *,
        ...
        """Persist Lara audit facts after Pygent has executed a tool."""
