...
from lara.core.io import jsonl_path_lock, plain_object, read_json, utc_now, write_json_atomic
...
FILE_EFFECT_TOOL_SPEC = ToolSpec(
    tool_id="lara.internal.persist_file_effects",
    version="1",
    definition=ToolDefinition(
        name="lara_persist_file_effects",
...
class FileEffectToolExecutor:
    sandbox_support = SandboxExecutorSupport(
        ...
        deployment_fingerprint="lara:file-effects:v1",
    )
