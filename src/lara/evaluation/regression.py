...
from lara.config import load_mapping_file
from lara.core.io import append_jsonl, write_json
from lara.schema import CaseRunRef, RunConfig
from lara.sessions import SessionManager
from lara.tracing import EventStore
from lara.workflows.case_run import execute_case_run
...
class RegressionRunner:
    def __init__(
        ...
        *,
        ...
        self.regressions_root = Path(config.lara_root) / "regressions"
