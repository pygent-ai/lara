...
from lara.core.io import utc_now, validate_path_id
...
class SessionCollaborationStore:
    ...
    def __init__(self, lara_root: str | Path) -> None:
        self.path = (
            Path(lara_root).resolve() / "runtime" / "session-collaboration-v1.sqlite3"
        )
