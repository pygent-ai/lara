...
from lara_api.models.requests import TerminalCommandRequest, TerminalResetRequest
from lara_api.models.responses import DeleteResponse, TerminalCommandResponse
