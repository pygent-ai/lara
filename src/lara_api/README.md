...
This layer adapts `src/lara` core capabilities to HTTP and server-sent event boundaries. Keep business logic in `src/lara`; routers and services here should stay thin and desktop-facing.
